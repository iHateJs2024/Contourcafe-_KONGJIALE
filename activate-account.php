...
$sql = "UPDATE pelanggan SET account_activation_hash = NULL WHERE idpelanggan = ?";

$stmt = $mysqli->prepare($sql);

$stmt->bind_param("s", $user["idpelanggan"]);
...
<body id="body">
  ...
  <main class="main">
    <div class="main-content">
      <h1>Aktivasi Akaun Berjaya!</h1>
      <p>Sila log masuk untuk melanjutkan penggunaan kami.</p>
