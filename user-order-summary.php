...
//! GET ALL THE COLUMNS IN pelanggan table
$idpelanggan = $_SESSION['idpelanggan'];
...
$stmt->bind_param("s", $idpelanggan); // "s" stands for string; adjust if needed
$stmt->execute();
...
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    $password_pelanggan = $row['password_pelanggan'];
    $nohp = $row['nohp'];
    ...
    <div class="main-content">
      ...
      <div class="food-order-details-container">
        <div class="food-order-details-and-buyer-details-container">
          ...
          <strong>Nama: <span><?= $namapelanggan; ?></span></strong>
          <strong>Nombor Telefon: <span><?= $nohp; ?></span></strong>
          <strong>E-mel: <span><?= $email_pelanggan; ?></span></strong>
          <strong>Alamat: <span><?= $alamat_pelanggan; ?></span></strong>
          <strong>Jumlah Item: <span><?= $totalItems; ?></span></strong>
              ...
              <li>
                ...
                <div class='item-container'>
                  <div class='left-item-details-container'>
                    <div class='item-name-and-quantity-container'>
                      <p class='item-name'>
                        " . $order['name'] . "
                      </p>
                  ...
                  <div class='right-item-details-container'>
                    ...
                    <div>
                      ...
                      <span>
                        RM" . number_format(($order['takeAwayPackaging'] * $order['quantity']) / 100, 2) . "
                      </span>
                    </div>
                  </div>
                </div>  
        ...
        <div class="button-container">
          <a class="menu-button" href="user-menu.php">
